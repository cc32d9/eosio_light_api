...
CREATE INDEX LIGHTAPI_LATEST_RESOURCE_I02 ON LIGHTAPI_LATEST_RESOURCE(irreversible, block_num);
...
CREATE INDEX LIGHTAPI_LATEST_CURRENCY_I04 ON LIGHTAPI_LATEST_CURRENCY (irreversible, block_num);
...
CREATE INDEX LIGHTAPI_AUTH_THRESHOLDS_I02 ON LIGHTAPI_AUTH_THRESHOLDS (irreversible, block_num);
