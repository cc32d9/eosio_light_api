...
CREATE UNIQUE INDEX TOKENAPI_LATEST_CURRENCY_I01 ON TOKENAPI_LATEST_CURRENCY (account_name, contract, currency);
CREATE INDEX TOKENAPI_LATEST_CURRENCY_I02 ON TOKENAPI_LATEST_CURRENCY (contract, currency, amount);
CREATE INDEX TOKENAPI_LATEST_CURRENCY_I03 ON TOKENAPI_LATEST_CURRENCY (currency, contract);
